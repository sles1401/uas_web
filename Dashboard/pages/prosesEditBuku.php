<?php
    ...
    $query = "UPDATE buku SET judul = '$judul_buku', id_penulis = '$id_penulis', id_penerbit = '$id_penerbit', id_kategori = '$id_kategori', stok = $stok,  harga = $harga, deskripsi = '$deskripsi' WHERE id_buku = '$id_buku'";
    ...
    else if(in_array($_FILES["gambar"]["type"],$tipe_file) && $nama_file != "")
    {
	    ...
	    $query = "UPDATE buku SET judul = '$judul_buku', id_penulis = '$id_penulis', id_penerbit = '$id_penerbit', id_kategori = '$id_kategori', stok = $stok,  harga = $harga, deskripsi = '$deskripsi', gambar='$nama_file' WHERE id_buku = '$id_buku'";
